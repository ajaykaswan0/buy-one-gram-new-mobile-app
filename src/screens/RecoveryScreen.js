...
const s = StyleSheet.create({
  safe:{flex:1,backgroundColor:'#F7F9FC'},header:{backgroundColor:'#0F766E',padding:16,flexDirection:'row',alignItems:'center',gap:14},back:{color:'#fff',fontWeight:'800'},title:{color:'#fff',fontSize:20,fontWeight:'900'},subtitle:{color:'#CCFBF1',fontSize:11},count:{marginLeft:'auto',backgroundColor:'#DC2626',borderRadius:18,minWidth:34,padding:8,alignItems:'center'},countText:{color:'#fff',fontWeight:'900'},search:{margin:14,marginBottom:5,borderWidth:1,borderColor:'#CBD5E1',borderRadius:12,padding:12,backgroundColor:'#fff',color:'#0F172A'},tabs:{flexDirection:'row',gap:8,paddingHorizontal:14,paddingTop:8},tab:{flex:1,padding:10,borderRadius:10,backgroundColor:'#E2E8F0',alignItems:'center'},tabActive:{backgroundColor:'#0F766E'},tabText:{fontSize:11,fontWeight:'800',color:'#475569'},tabTextActive:{color:'#fff'},error:{margin:14,padding:10,borderRadius:8,backgroundColor:'#FEE2E2',color:'#B91C1C'},list:{padding:14,paddingBottom:40},card:{backgroundColor:'#fff',borderRadius:15,padding:15,marginBottom:12,borderWidth:1,borderColor:'#E2E8F0'},partyHeader:{flexDirection:'row',justifyContent:'space-between',gap:12,paddingBottom:12},partyBalance:{alignItems:'flex-end'},billCard:{borderTopWidth:1,borderColor:'#E2E8F0',paddingTop:12,marginTop:5,marginBottom:8},billAmounts:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginTop:7},cardTop:{flexDirection:'row',justifyContent:'space-between',gap:10},party:{fontSize:16,fontWeight:'900',color:'#0F172A'},invoiceNo:{fontSize:12,fontWeight:'800',color:'#2563EB',marginTop:3},overdue:{backgroundColor:'#FEE2E2',borderRadius:16,paddingHorizontal:9,paddingVertical:6},overdueText:{fontSize:10,color:'#B91C1C',fontWeight:'900'},amountRow:{flexDirection:'row',justifyContent:'space-between',marginVertical:14,paddingVertical:12,borderTopWidth:1,borderBottomWidth:1,borderColor:'#E2E8F0'},label:{fontSize:10,color:'#64748B',fontWeight:'700'},amount:{fontSize:20,fontWeight:'900',color:'#DC2626',marginTop:3},value:{fontSize:14,fontWeight:'800',color:'#0F172A',marginTop:3},details:{gap:5},detail:{fontSize:11,color:'#64748B'},salesman:{fontSize:12,color:'#0F172A',fontWeight:'800'},followUp:{marginTop:11,padding:10,borderRadius:9,backgroundColor:'#FEF3C7'},followUpDate:{fontSize:11,fontWeight:'900',color:'#92400E'},followUpRemark:{fontSize:11,color:'#A16207',marginTop:3},actions:{flexDirection:'row',flexWrap:'wrap',gap:9,marginTop:14},actionButton:{minWidth:80,backgroundColor:'#0F766E',borderRadius:10,padding:11,alignItems:'center'},actionText:{color:'#fff',fontWeight:'900'},primary:{flex:1,backgroundColor:'#2563EB',borderRadius:10,padding:11,alignItems:'center'},primaryText:{color:'#fff',fontWeight:'900'},secondary:{flex:1,borderWidth:1,borderColor:'#2563EB',borderRadius:10,padding:11,alignItems:'center'},secondaryText:{color:'#2563EB',fontWeight:'900'},empty:{alignItems:'center',padding:45},emptyTitle:{fontSize:17,fontWeight:'900',color:'#0F172A'},emptyText:{fontSize:12,color:'#64748B',textAlign:'center',marginTop:7},modal:{flex:1,backgroundColor:'rgba(0,0,0,.72)',justifyContent:'center',padding:18},proofBox:{backgroundColor:'#fff',borderRadius:16,padding:16},modalTitle:{fontSize:17,fontWeight:'900',color:'#0F172A',marginBottom:12},proofImage:{width:'100%',height:430,backgroundColor:'#F1F5F9'},invoiceBox:{backgroundColor:'#fff',borderRadius:16,padding:16,maxHeight:'90%'},invoiceTitle:{fontSize:12,fontWeight:'800',color:'#64748B',textAlign:'center'},invoiceNumber:{fontSize:20,fontWeight:'900',color:'#0F172A',textAlign:'center'},invoiceParty:{fontSize:15,fontWeight:'800',color:'#0F172A',marginTop:18},invoiceItem:{flexDirection:'row',justifyContent:'space-between',paddingVertical:11,borderBottomWidth:1,borderColor:'#E2E8F0'},itemName:{fontWeight:'800',color:'#0F172A'},itemAmount:{fontWeight:'900',color:'#0F172A'},invoiceTotal:{alignItems:'flex-end',paddingVertical:18},actionBox:{backgroundColor:'#fff',borderRadius:16,padding:17,maxHeight:'90%'},actionScroll:{paddingBottom:6},actionParty:{fontSize:15,fontWeight:'900',color:'#0F172A'},actionInvoice:{fontSize:12,color:'#64748B',marginTop:3,marginBottom:15},fieldLabel:{fontSize:11,fontWeight:'800',color:'#475569',marginTop:10,marginBottom:5},field:{borderWidth:1,borderColor:'#CBD5E1',borderRadius:10,padding:11,color:'#0F172A',backgroundColor:'#fff'},remarkField:{minHeight:90,textAlignVertical:'top'},modalActions:{flexDirection:'row',gap:10,marginTop:18},calendar:{borderWidth:1,borderColor:'#CBD5E1',borderRadius:12,padding:10,backgroundColor:'#fff'},calendarHead:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},calendarNav:{fontSize:27,fontWeight:'900',color:'#0F766E',paddingHorizontal:12},calendarTitle:{fontSize:14,fontWeight:'900',color:'#0F172A'},weekRow:{flexDirection:'row',marginTop:5},weekDay:{width:'14.285%',textAlign:'center',fontSize:10,fontWeight:'900',color:'#64748B'},dayGrid:{flexDirection:'row',flexWrap:'wrap',marginTop:3},dayCell:{width:'14.285%',height:34,alignItems:'center',justifyContent:'center',borderRadius:17},daySelected:{backgroundColor:'#0F766E'},dayText:{fontSize:12,fontWeight:'700',color:'#0F172A'},dayDisabled:{color:'#CBD5E1'},dayTextSelected:{color:'#fff'},selectedDate:{textAlign:'center',marginTop:7,fontSize:11,fontWeight:'800',color:'#0F766E'},
});
