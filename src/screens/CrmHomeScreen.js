...
const s=StyleSheet.create({safe:{flex:1,backgroundColor:'#F7F9FC'},body:{padding:16,paddingBottom:42},welcome:{backgroundColor:'#0F766E',borderRadius:18,padding:18,flexDirection:'row',justifyContent:'space-between',alignItems:'flex-start'},eyebrow:{fontSize:10,fontWeight:'800',letterSpacing:1.4,color:'#99F6E4'},title:{fontSize:22,fontWeight:'900',color:'#fff',marginTop:5},subtitle:{fontSize:12,color:'#CCFBF1',marginTop:5,maxWidth:240},online:{backgroundColor:'rgba(255,255,255,.18)',paddingHorizontal:9,paddingVertical:6,borderRadius:20},onlineActive:{backgroundColor:'#16A34A'},onlineText:{fontSize:9,fontWeight:'900',color:'#fff'},stats:{flexDirection:'row',gap:12,marginTop:14},stat:{flex:1,backgroundColor:'#fff',borderRadius:14,padding:15,borderWidth:1,borderColor:'#E2E8F0'},statLabel:{fontSize:11,color:'#718096',fontWeight:'700'},statValue:{fontSize:22,color:'#1A202C',fontWeight:'900',marginTop:7},statHint:{fontSize:10,color:'#A0AEC0',marginTop:5},card:{backgroundColor:'#fff',borderRadius:16,padding:16,marginTop:14,borderWidth:1,borderColor:'#E2E8F0'},cardTitle:{fontSize:16,fontWeight:'900',color:'#1A202C',marginBottom:14},grid:{flexDirection:'row',flexWrap:'wrap',rowGap:18},action:{width:'33.33%',alignItems:'center'},icon:{width:50,height:50,borderRadius:25,backgroundColor:'#E6FFFA',borderWidth:1,borderColor:'#81E6D9',alignItems:'center',justifyContent:'center'},iconText:{fontSize:21,fontWeight:'900',color:'#00796B'},actionText:{fontSize:11,color:'#2D3748',fontWeight:'700',marginTop:7,textAlign:'center'},focus:{backgroundColor:'#FFFBEB',borderColor:'#FDE68A',borderWidth:1,borderRadius:14,padding:15,marginTop:14},focusTitle:{fontWeight:'900',color:'#92400E'},focusText:{fontSize:12,color:'#A16207',lineHeight:18,marginTop:5}});
